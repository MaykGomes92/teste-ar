...
import { Plus, Trash2, Edit, Shield, List } from "lucide-react";
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogTrigger } from "@/components/ui/dialog";
import { Textarea } from "@/components/ui/textarea";

const CadastroColunasControles = () => {
  const [colunas, setColunas] = useState([
    { 
      id: 1, 
      nome: "Tipo de Controle", 
      tipo: "Lista", 
      opcoes: ["Preventivo", "Detectivo", "Corretivo"],
      obrigatorio: true
    },
    { 
      id: 2, 
      nome: "Frequência", 
      tipo: "Lista", 
      opcoes: ["Diária", "Semanal", "Mensal", "Trimestral", "Anual"],
      obrigatorio: true
    },
    { 
      id: 3, 
      nome: "Automatização", 
      tipo: "Lista", 
      opcoes: ["Manual", "Automático", "Semi-automático"],
      obrigatorio: true
    },
    { 
      id: 4, 
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-slate-800">Colunas para Controles</h3>
        <Dialog>
          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="nomeColunaControle">Nome da Coluna</Label>
                <Input
                  id="nomeColunaControle"
                  value={novaColuna.nome}
                  onChange={(e) => setNovaColuna({...novaColuna, nome: e.target.value})}
                  placeholder="Ex: Criticidade do Controle"
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="tipoColunaControle">Tipo de Campo</Label>
              ...
              {novaColuna.tipo === "Lista" && (
                <div className="space-y-2">
                  <Label htmlFor="opcoesControle">Opções (separadas por vírgula)</Label>
                  <Textarea
                    id="opcoesControle"
...
export default CadastroColunasControles;
