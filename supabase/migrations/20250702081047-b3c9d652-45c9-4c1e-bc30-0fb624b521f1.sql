-- Adicionar dados completos para demonstração TechCorp
...
('Teste de Validação Tarifária', 'Verificação da aplicação correta dos fatores de risco na precificação', 'SUB-DEM', '2024-01-15', 'Auditor Junior - Lucas Ferreira', 'Auditor Senior - Renata Oliveira', 85, 90, 'Análise de amostra de 50 cotações, verificando aplicação de fatores de risco e cálculos. Todas as cotações testadas apresentaram cálculos corretos.', 'dd1aceb7-8477-4b8c-8cd6-f68de1186417', 3),
('Teste de Constituição de Reservas', 'Validação do cálculo de reservas IBNR conforme metodologia atuarial', 'REG-DEM', '2024-01-20', 'Atuário Pleno - Marina Santos', 'Atuário Senior - João Pedro', 92, 88, 'Revisão completa da metodologia de cálculo de IBNR. Metodologia aprovada pelo Comitê de Riscos.', 'dd1aceb7-8477-4b8c-8cd6-f68de1186417', 3);
