...
SELECT 
  'c0a80000-0000-4000-8000-000000000001'::uuid,
...
WHERE NOT EXISTS (
  ...
  WHERE id = 'c0a80000-0000-4000-8000-000000000001'::uuid
);
...
WHERE NOT EXISTS (
  ...
  WHERE project_info_id = 'c0a80000-0000-4000-8000-000000000001'::uuid
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM public.project_users pu 
  WHERE pu.project_id = 'c0a80000-0000-4000-8000-000000000001'::uuid 
  AND pu.user_id = p.id
);