...
-- Create a demo project for testing with proper UUID
INSERT INTO public.project_info (
  id,
  user_id,
  nome_projeto,
...
SELECT 
  'a1b2c3d4-e5f6-4789-a012-123456789abc'::uuid,
  (SELECT id FROM public.profiles LIMIT 1),
...
WHERE NOT EXISTS (
  SELECT 1 FROM public.project_info 
  WHERE id = 'a1b2c3d4-e5f6-4789-a012-123456789abc'::uuid
);
...
WHERE NOT EXISTS (
  SELECT 1 FROM public.project_users pu 
  WHERE pu.project_id = 'a1b2c3d4-e5f6-4789-a012-123456789abc'::uuid 
  AND pu.user_id = p.id
);