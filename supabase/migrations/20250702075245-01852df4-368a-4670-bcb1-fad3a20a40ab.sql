...
-- Limpar projetos mantendo apenas o template do IRB(Re) na ordem correta
-- Manter apenas o projeto: bedaf5d7-aa02-4d46-a692-e16a5acd5e01 (IRB(Re) - Template)

-- 1. Primeiro excluir registros que referenciam outras tabelas
...
-- 2. Depois excluir dados das planilhas e processos
...
-- 3. Por último, excluir registros relacionados ao projeto
